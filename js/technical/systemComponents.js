var systemComponents = {
    ...
    'info-tab': {
		...
		<br><br>
        你已经玩了 {{ formatTime(player.timePlayed) }}<br><br>
        <h3>快捷键</h3><br>
    ...
    'options-tab': {
        ...
        <table>
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('autosave')">自动保存: {{ options.autosave?"ON":"OFF" }}</button></td>
                <td><button class="opt" onclick="hardReset()">炸了你的存档</button></td>
            </tr>
            <tr>
                <td><button class="opt" onclick="exportSave()">把保存扔进剪贴板</button></td>
                <td><button class="opt" onclick="importSave()">导入保存</button></td>
                <td><button class="opt" onclick="toggleOpt('offlineProd')">离线收益: {{ options.offlineProd?"ON":"OFF" }}</button></td>
            </tr>
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('hqTree')">高质量的树: {{ options.hqTree?"ON":"OFF" }}</button></td>
            </tr>
            <tr>
                <td><button class="opt" onclick="toggleOpt('hideChallenges')">已完成挑战: {{ options.hideChallenges?"HIDDEN":"SHOWN" }}</button></td>
                <td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">单标签模式: {{ options.forceOneTab?"ALWAYS":"AUTO" }}</button></td>
				<td><button class="opt" onclick="toggleOpt('forceTooltips'); needsCanvasUpdate = true">Shift-Click to Toggle Tooltips: {{ options.forceTooltips?"ON":"OFF" }}</button></td>
				</tr> 
			<tr>
                <td><button class="opt" onclick="toggleOpt('hideMilestonePopups')">里程碑提示: {{ formatOption(!options.hideMilestonePopups) }}</button></td>
            </tr>
        </table>`
    },
